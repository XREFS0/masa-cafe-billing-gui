...
root.title("MASA CafePOS System")
...
lblinfo = Label(Tops, font=("aria", 30, "bold"), text="CAFE BILLING SYSTEM", fg="Black", bd=10, anchor="w")
...
txtreference = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=rand, bd=6, insertwidth=6, bg="yellow", justify="right"
)
...
txtfries = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=Fries, bd=6, insertwidth=4, bg="green", justify="right"
)
...
txtLargefries = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=Largefries, bd=6, insertwidth=4, bg="green", justify="right"
)
...
txtburger = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=Burger, bd=6, insertwidth=4, bg="green", justify="right"
)
...
txtFilet = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=Filet, bd=6, insertwidth=4, bg="green", justify="right"
)
...
txtDrinks = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=Drinks, bd=6, insertwidth=4, bg="green", justify="right"
)
...
txtcost = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=cost, bd=6, insertwidth=4, bg="white", justify="right"
)
...
txtTax = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=Tax, bd=6, insertwidth=4, bg="white", justify="right"
)
...
txtSubtotal = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=Subtotal, bd=6, insertwidth=4, bg="white", justify="right"
)
...
txtTotal = Entry(
    f1, font=("ariel", 16, "bold"), textvariable=Total, bd=6, insertwidth=4, bg="grey", justify="right"
)
